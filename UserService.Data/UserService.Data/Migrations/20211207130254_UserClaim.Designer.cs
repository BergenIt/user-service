...
namespace UserService.Data.Migrations
{
    ...
    [Migration("20211207130254_UserClaim")]
            ...
            modelBuilder.Entity("UserService.Core.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("00000001-0000-0000-0000-000000000000"),
                            ConcurrencyStamp = "dc31e5b8-1c75-4a09-9078-ed470307cbe5",
                            Name = "Admin",
            ...
            modelBuilder.Entity("UserService.Core.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("00000001-0000-0000-0000-000000000000"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "cca19c90-08e5-46e0-ade8-9e0a60c5326a",
                            ...
                            SecurityStamp = "75dea6ac-0166-43f5-829c-507d6890279a",
            ...
            modelBuilder.Entity("UserService.Core.Entity.UserClaim", b =>
                {
                    ...
                    b.HasKey("UserId", "ClaimValue", "ClaimType");
