...
namespace UserService.Data.Migrations
{
    ...
    [Migration("20211216161620_RmNotify")]
            ...
            modelBuilder.Entity("UserService.Core.Entity.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = new Guid("00000001-0000-0000-0000-000000000000"),
                            ConcurrencyStamp = "8f112af6-5add-44c9-921b-96daa3729c72",
                            Name = "Admin",
            ...
            modelBuilder.Entity("UserService.Core.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("00000001-0000-0000-0000-000000000000"),
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "56ddbcde-40cd-4684-a394-e3b11198d9a0",
                            ...
                            SecurityStamp = "9c8fb487-f664-4e75-b68a-f6e1d6e6f506",
